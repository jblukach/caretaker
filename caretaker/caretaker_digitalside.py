...
class CaretakerDigitalSide(Stack):
    ...
    ### LAMBDA ###
        ...
        parameter = _ssm.StringParameter(
            ...
            parameter_name = '/caretaker/ip/digitalside',
            string_value = digitalside.function_name,
    ...
    ### LAMBDA ###
        ...
        parameter = _ssm.StringParameter(
            self, 'parameter2',
            description = 'Project Caretaker',
            parameter_name = '/caretaker/dns/digitalside',
            string_value = digitalsidedomain.function_name,
            tier = _ssm.ParameterTier.STANDARD
        )
