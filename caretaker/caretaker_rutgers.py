...
class CaretakerRutgers(Stack):
    ...
    ### LAMBDA CONTAINER ###
        ...
        rutgers = _lambda.DockerImageFunction(
            self, 'rutgers',
            code = _lambda.DockerImageCode.from_image_asset('sources/rutgers'),
        ...
        logs = _logs.LogGroup(
            self, 'logs',
            log_group_name = '/aws/lambda/'+rutgers.function_name,
