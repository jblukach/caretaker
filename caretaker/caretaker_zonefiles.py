...
class CaretakerZoneFiles(Stack):
    ...
    ### LAMBDA ###
        ...
        parameter = _ssm.StringParameter(
            ...
            parameter_name = '/caretaker/ip/zonefiles',
            string_value = zonefiles.function_name,
        ...
        event.add_target(
            _targets.LambdaFunction(zonefiles)
        )
    ...
    ### LAMBDA ###
        ...
        parameter = _ssm.StringParameter(
            self, 'parameter2',
            description = 'Project Caretaker',
            parameter_name = '/caretaker/dns/zonefiles',
            string_value = zonefilesdomain.function_name,
            tier = _ssm.ParameterTier.STANDARD
        )
        ...
        zonefilesdomainevent.add_target(
            _targets.LambdaFunction(zonefilesdomain)
        )
