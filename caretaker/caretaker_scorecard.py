...
class CaretakerScoreCard(Stack):
    ...
    ### LAMBDA CONTAINER ###
        ...
        scorecard = _lambda.DockerImageFunction(
            self, 'scorecard',
            code = _lambda.DockerImageCode.from_image_asset('sources/scorecard'),
        ...
        logs = _logs.LogGroup(
            self, 'logs',
            log_group_name = '/aws/lambda/'+scorecard.function_name,
        ...
        event.add_target(
            _targets.LambdaFunction(scorecard)
        )
