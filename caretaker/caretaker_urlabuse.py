...
class CaretakerUrlAbuse(Stack):
    ...
    ### LAMBDA ###
        ...
        parameter = _ssm.StringParameter(
            ...
            parameter_name = '/caretaker/dns/urlabuse',
            string_value = urlabuse.function_name,
        ...
        urlabusesub = _logs.SubscriptionFilter(
            self, 'urlabusesub',
            log_group = urlabuselogs,
            destination = _destinations.LambdaDestination(error),
            filter_pattern = _logs.FilterPattern.all_terms('ERROR')
        )

        urlabusetime = _logs.SubscriptionFilter(
            self, 'urlabusetime',
            log_group = urlabuselogs,
