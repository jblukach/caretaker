...
class CaretakerCinsScore(Stack):
    ...
    ### LAMBDA CONTAINER ###
        ...
        cinsscore = _lambda.DockerImageFunction(
            self, 'cinsscore',
            code = _lambda.DockerImageCode.from_image_asset('sources/cinsscore'),
        ...
        logs = _logs.LogGroup(
            self, 'logs',
            log_group_name = '/aws/lambda/'+cinsscore.function_name,
        ...
        event.add_target(
            _targets.LambdaFunction(cinsscore)
        )
