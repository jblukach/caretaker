...
def handler(event, context):
    ...
    response = requests.get('https://osint.digitalside.it/Threat-Intel/lists/latestips.txt', headers=headers)
    data = response.text
    ...
    s3.meta.client.upload_file(
        '/tmp/digitalside4.txt',
        os.environ['S3_BUCKET'],
        'ipv4/digitalside.txt',
        ExtraArgs = {
