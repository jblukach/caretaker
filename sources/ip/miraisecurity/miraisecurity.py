...
def handler(event, context):
    ...
    response = requests.get('https://mirai.security.gives/data/ip_list.txt', headers=headers)
    data = response.text
    ...
    f = open('/tmp/miraisecurity4.txt', 'w')
    ...
    s3.meta.client.upload_file(
        '/tmp/miraisecurity4.txt',
        'projectcaretaker',
        'ipv4/miraisecurity.txt',
        ExtraArgs = {
    ...
    return {
        'statusCode': 200,
        'body': json.dumps('Check Mirai Security Blocklist')
    }