...
def handler(event, context):
    ...
    response = requests.get('http://www.talosintelligence.com/documents/ip-blacklist', headers=headers)
    data = response.text
    ...
    s3.meta.client.upload_file(
        '/tmp/talosintelligence.txt',
        'projectcaretaker',
        'ip/talosintelligence.txt',
        ExtraArgs = {
    ...
    return {
        'statusCode': 200,
        'body': json.dumps('Check Talos Intelligence Blocklist')
    }