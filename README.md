...
Every Monday at 9:00 AM UTC, queries run against **Censys** for certificates with the province of either **North Dakota** or the abbreviation **ND** to collect **21,746** domain names for ```apex``` and ```www``` brand monitoring.
