...
| IPMI | IPP | ISCSI | KRPC |
| KUBERNETES | LDAP | MEMCACHED | MMS |
| MODBUS | MONERO_P2P | MONGODB | MQTT |
| MSSQL | MYSQL | NETBIOS | OPC_UA |
| ORACLE | PC_ANYWHERE | PCOM | POP3 |
| POSTGRES | PPTP | PROMETHEUS | REDIS |
| ROCKETMQ | RDP | RTSP | S7 |
| SCCM | SIP | SKINNY | SMB |
| SNMP **+** | SSDP | TEAM_VIEWER | TELNET |
| TFTP | TPLINK_KASA | UPNP | VNC |
| WHOIS | WINRM | X11 | ZEROMQ |
